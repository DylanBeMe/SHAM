...
This is an endpoint inventory for SHAM 1.0.0. It complements [API and CLI](api-and-cli.md), which focuses on automation patterns and stable CLI-oriented use.
