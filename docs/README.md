...
This manual documents the current SHAM 1.0.0 feature set. The root [README](../README.md) is an overview; use these guides for operating and automating the application.
