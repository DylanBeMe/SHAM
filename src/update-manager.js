...
const MANAGED_PATHS = ['src', 'public', 'examples', 'test', 'scripts', '.github', 'README.md', 'AUDIT-REPORT.md', 'CHANGELOG.md', 'CONTRIBUTING.md', 'RELEASING.md', 'SECURITY.md', 'Dockerfile', 'docker-compose.yml', 'docker-compose.isolation.yml', '.dockerignore', '.env.example', '.gitattributes', '.gitignore', 'LICENSE', 'package.json', 'package-lock.json'];
